...
<div>
    <form action="{{route('update.profile',$user->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input value="{{$user->name}}" name="name" type="text" class="form-control" id="formGroupExampleInput"
        ...
        <div class="mb-3">
            ...
            <input value="{{$user->address}}" name="address" type="text" class="form-control"
                id="formGroupExampleInput2" placeholder="Enter Address">
        </div>
        <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">Email</label>
            <input value="{{$user->email}}" name="email" type="text" class="form-control" id="formGroupExampleInput2"
