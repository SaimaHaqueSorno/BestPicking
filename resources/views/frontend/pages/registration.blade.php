...
<form class="login100-form validate-form" action="{{route('customer.registration')}}" method="POST">
@csrf
                     ...
                     @if(session()->has('message'))
                        <p><span class="btn btn-success">{{session()->get('message')}}</span></p>
                     @endif
<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter name: abc">
