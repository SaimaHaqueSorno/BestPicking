...
<head>
    <script nonce="179a9320-a650-4e1d-bb34-e4ba4afb2fd1">
        (function (w, d) {
            ! function (a, e, t, r) {
                a.zarazData = a.zarazData || {}, a.zarazData.executed = [], a.zarazData.tracks = [], a.zaraz = {
                    ...
                    n && (a.zarazData.t = e.getElementsByTagName("title")[0].text), a.zarazData.w = a
                        ...
                        "/cdn-cgi/zaraz/s.js?z=" + btoa(encodeURIComponent(JSON.stringify(a
    ...
    <link rel="stylesheet" type="text/css"
        href="https://colorlib.com/etc/lf/Login_v7/vendor/bootstrap/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css"
        href="https://colorlib.com/etc/lf/Login_v7/fonts/font-awesome-4.7.0/css/font-awesome.min.css">

    <link rel="stylesheet" type="text/css"
        href="https://colorlib.com/etc/lf/Login_v7/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">

    <link rel="stylesheet" type="text/css" href="https://colorlib.com/etc/lf/Login_v7/vendor/animate/animate.css">

    <link rel="stylesheet" type="text/css"
        href="https://colorlib.com/etc/lf/Login_v7/vendor/css-hamburgers/hamburgers.min.css">

    <link rel="stylesheet" type="text/css"
        href="https://colorlib.com/etc/lf/Login_v7/vendor/animsition/css/animsition.min.css">

    <link rel="stylesheet" type="text/css" href="https://colorlib.com/etc/lf/Login_v7/vendor/select2/select2.min.css">

    <link rel="stylesheet" type="text/css"
        href="https://colorlib.com/etc/lf/Login_v7/vendor/daterangepicker/daterangepicker.css">
...
<body>
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"6f47f45e8f988994","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.12.0","si":100}'
