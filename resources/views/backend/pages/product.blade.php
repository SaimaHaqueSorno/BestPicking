...
<form action="{{route('product.post')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input required name="quantity" type="number" class="form-control" id="formGroupExampleInput2"
    ...
    <div  class="mb-3">
    <label for="formGroupExampleInput2" class="form-label"> Feature Product</label><br>
    <input type="radio" name="feature_product" value="1" required/>Yes
    <input type="radio" name="feature_product" value="0" required/>No
    </div>
