...
<form action="{{route('product.update',$product->id)}}" method="POST" enctype="multipart/data-form">
    ...
    <div class="mb-3">
        ...
        <input value="{{$product->name}}" name="name" type="text" class="form-control" id="formGroupExampleInput"
    ...
    <div class="mb-3">
        ...
        <input value="{{$product->quantity}}" name="quantity" type="text" class="form-control"
            id="formGroupExampleInput2" placeholder="Enter quantity">
    </div>

    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Price</label>
        <input value="{{$product->price}}" name="price" type="text" class="form-control" id="formGroupExampleInput2"
    ...
    <div class="mb-3">
        ...
        <input value="{{$product->details}}" name="details" type="text" class="form-control" id="formGroupExampleInput2"
